...
// on déclare le nouvel utilisateur, et le fomulaire vide
    ...
    if(isset($_POST['nom'] )&& $_POST['nom'] != ''){
        ...
        // on vérifie que tout les champs sont remplis
            ...
            $courriel = sql("SELECT email FROM utilisateur");
            if (count($courriel) > 0) {                                           
                        echo '<section class="container">
                                <div class="row">
                                    <div class="col-xs-offset-3 col-xs-6">
                                        <p class="bg-danger alert">Cette email est déjà pris</p></br>
                                    </div>
                                </div>
                            </section>';
    ...
    ?>
        ...
        <section class="container">
            ...
            $nb_utilisateur = sql("SELECT nom, email, id FROM utilisateur");
         ...
         ?>
                        ...
                        <input class="form-control" type="text" name="email" value="<?php echo $nom['email']; ?>">
